...
if __name__ == "__main__":
    ...
    print('Narrow pin code 2-2-2-2-2-3-3')
    ...
    writesparsematrix(PCX, 'PCMatrices/narrowCC/narrowCC_2222233_dim{}_X.sms'.format(D))
    writesparsematrix(PCZ, 'PCMatrices/narrowCC/narrowCC_2222233_dim{}_Z.sms'.format(D))
