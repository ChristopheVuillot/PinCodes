...
if __name__ == "__main__":
    ...
    print('Narrow pin code 2-3-2-3-2-3-2')
    M33 = np.array([[1, 1, 0], [0, 1, 1], [1, 0, 1]], dtype='uint8')
    TRANSITIONS = [np.ones((2, 3), dtype='uint8'),
                   np.ones((3, 2), dtype='uint8'),
    ...
    writesparsematrix(PCX, 'PCMatrices/narrowCC/narrowCC_alt32_dim{}_X.sms'.format(D))
    writesparsematrix(PCZ, 'PCMatrices/narrowCC/narrowCC_alt32_dim{}_Z.sms'.format(D))
