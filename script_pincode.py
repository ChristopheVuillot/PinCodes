...
if __name__ == "__main__":
    ...
    # ALL1COSETS = []
    # for j in range(4):
    #     ALL1COSETS += readcosetfile('PCMatrices/535_531360_'+str(j)+'.cos')
    # ALL2COSETS = []
    ...
    #         PCZCOS[j, elem-1] = 1
    # TIME = time.localtime()
    writesparsematrix(PCX, 'PCMatrices/535_531360_X.sms')
    writesparsematrix(PCZ, 'PCMatrices/535_531360_Z.sms')
    # writesparsematrix(PCXCOS, 'PCMatrices/535_531360_XCOS.sms')
    # writesparsematrix(PCZCOS, 'PCMatrices/535_531360_ZCOS.sms')
