...
if __name__ == "__main__":
    ...
    LX = 3
    X = LX - 1
    print('Generating CC..CZ Pin Code 442222244')
    ...
    writesparsematrix(PCX, 'PCMatrices/notgauge/cczpinco_442222244_dim{}_X.sms'.format(D))
    writesparsematrix(PCZ, 'PCMatrices/notgauge/cczpinco_442222244_dim{}_Z.sms'.format(D))
