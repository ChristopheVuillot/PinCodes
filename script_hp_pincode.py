...
if __name__ == "__main__":
    for SEED in range(1000, 1100):
        ...
        for j, bmap in enumerate(TRANSITIONS):
            writesparsematrix(bmap, 'BoundaryMaps/randomhp_{}_{}.sms'.format(SEED, j))
        ...
        writesparsematrix(PCX, 'PCMatrices/randomhp_{}_X.sms'.format(SEED))
        writesparsematrix(PCZ, 'PCMatrices/randomhp_{}_Z.sms'.format(SEED))
